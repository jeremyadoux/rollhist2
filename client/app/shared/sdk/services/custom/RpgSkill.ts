...
/**
 * Api services for the `RpgSkill` model.
 */
@Injectable()
export class RpgSkillApi extends BaseLoopBackApi {
  ...
  public findByIdRpgPlayerRpgSkill(id: any, fk: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RpgSkills/:id/rpgPlayerRpgSkill/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries rpgPlayerRpgSkill of RpgSkill.
   *
   * @param {any} id RpgSkill id
   *
   * @param {object} filter 
  ...
  /**
   * Counts rpgPlayerRpgSkill of RpgSkill.
   *
   * @param {any} id RpgSkill id
   *
  ...
  public countRpgPlayerRpgSkill(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RpgSkills/:id/rpgPlayerRpgSkill/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
